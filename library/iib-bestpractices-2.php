			...
			<div class="container">
				<div class="row">
					<div class="col-sm-7 text-left">
						<br> <br> <br> <br> <br>
						<h1 class="micro" style="color: white;">Best Practices for 
					<strong>IBM Integration Bus Deployments</strong></h1>
					...
					<!-- This is the divider line between the heading and the content -->
						...
						<ul class="methodText">
							...
							<li>One way is through the use of RouteToLabel node. This node
								makes use of the Destination List array of the LocalEnvironment
					...
					<!-- This is the divider line between the heading and the content -->
						...
						<ul class="methodText">
							<li>Message Flows can be divided into SubFlows. Essentially, a
								...
								maintainability and offers opportunity for reuse.</li>
						</ul>
					...
					<!-- This is the divider line between the heading and the content -->
						...
						<ul class="methodText">
							...
							<li>Reference variables can be used to store locations in any
								type of message tree (InputRoot, OutputRoot, LocalEnvironment,
								Environment, etc).</li>
