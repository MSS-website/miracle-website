...
.item {
   ...
   <body>
      ...
      <div class="container ">
         <div class="row">
            		<div class="col-sm-3 item item-type-double">
		<a class="item-hover" href="../../events/womens-day-2017.php" target="_blank">
			<div class="item-info">
				<div class="date">March 08th, 2017</div>			
				<div class="line"></div>			
				<div class="headline">Womens Day</div>
				<div class="line"></div>
			</div>
			<div class="mask"></div>
		</a>
		<div class="item-img"><center><img src="images/womens-day1-2017.png" alt="" /></center></div>
	</div>	
	
	<div class="col-sm-3 item item-type-double">
		<a class="item-hover" href="../../events/valentines-day-2017.php" target="_blank">
			<div class="item-info">
				<div class="date">February 14th , 2017</div>			
				<div class="line"></div>			
				<div class="headline">Valentines Day</div>
				<div class="line"></div>
			</div>
			<div class="mask"></div>
		</a>
		<div class="item-img"><img src="images/valentine.png" alt="" /></div>
	</div>	
	
	<div class="col-sm-3 item item-type-double">
		<a class="item-hover" href="../../events/annual-winter-picnic-2016.php" target="_blank">
			<div class="item-info">
				<div class="date">November 5th , 2016</div>			
				<div class="line"></div>			
				<div class="headline">Araku Picnic | 2016</div>
				<div class="line"></div>
			</div>
			<div class="mask"></div>
		</a>
		<div class="item-img"><img src="images/araku-picnic-2016.png" alt="" /></div>
	</div>	
	
	<div class="col-sm-3 item item-type-double">
		<a class="item-hover" href="../../events/ds-16.php" target="_blank">
			<div class="item-info">
				<div class="date">December 12th to 17th, 2016</div>			
				<div class="line"></div>			
				<div class="headline">Digital Summit | 2016</div>
				<div class="line"></div>
			</div>
			<div class="mask"></div>
		</a>
		<div class="item-img"><img src="images/DS-16.png" alt="" /></div>
	</div>	
	
	</div>
	<div class="row">
            		<div class="col-sm-3 item item-type-double">
		<a class="item-hover" href="../../events/q1-meet-2017.php" target="_blank">
			<div class="item-info">
				<div class="date">May 4th, 2017</div>			
				<div class="line"></div>			
				<div class="headline">Quarterly Meet 1 | 2017</div>
				<div class="line"></div>
			</div>
			<div class="mask"></div>
		</a>
		<div class="item-img"><center><img src="images/q1-meet-2017.png" alt="" /></center></div>
	</div>	
	
	<div class="col-sm-3 item item-type-double">
		<a class="item-hover" href="../../events/internship-2017.php" target="_blank">
			<div class="item-info">
				<div class="date">May 3th, 2017</div>			
				<div class="line"></div>			
				<div class="headline">Internship | 2017</div>
				<div class="line"></div>
			</div>
			<div class="mask"></div>
		</a>
		<div class="item-img"><img src="images/internship-2017.png" alt="" /></div>
	</div>	
	
	<div class="col-sm-3 item item-type-double">
		<a class="item-hover" href="../../events/epl-event2016.php" target="_blank">
			<div class="item-info">
				<div class="date">NSeptember - January, 2016</div>			
				<div class="line"></div>			
				<div class="headline">EPL | 2016 </div>
				<div class="line"></div>
			</div>
			<div class="mask"></div>
		</a>
		<div class="item-img"><img src="images/epl-16-SAP.png" alt="" /></div>
	</div>	
	
	<div class="col-sm-3 item item-type-double">
		<a class="item-hover" href="../../events/apcloud-event.php" target="_blank">
			<div class="item-info">
				<div class="date">August 5th , 2016</div>			
				<div class="line"></div>			
				<div class="headline">AP Cloud Initiative</div>
				<div class="line"></div>
			</div>
			<div class="mask"></div>
		</a>
		<div class="item-img"><img src="images/apcloud.png" alt="" /></div>
	</div>	
