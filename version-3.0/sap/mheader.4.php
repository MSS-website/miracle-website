     ...
     <header id="header" class="transparent-header full-header page-section" data-sticky-class="not-dark">
			...
			<div id="header-wrap">
				...
				<div class=" clearfix">
					...
					============================================= -->
					<div id="logo">
						<a href="index.html" class="standard-logo" data-dark-logo="../images/miracle-logo.svg" width="150px" height="70px"><img src="../images/miracle-logo.svg" width="150px" height="70px"alt="Miracle Logo" style="margin-left:15px;"></a>
					...
					<nav id="primary-menu" style="padding-top:5px;">
						...
						<ul>
							...
							<li class="mega-menu"><a href="#"><div>events</div></a>
								...
								<!--<li class="mega-menu"><a href="http://www.miraclesoft.com/events/"><div class="head">Events</div></a>
								<ul>
								<li><a href="http://www.miraclesoft.com/events/"><div>upcoming Events</div></a></li>
								<li><a href="http://www.miraclesoft.com/events/recent"><div>Recent Events</div></a></li>
								<li><a href="http://www.miraclesoft.com/gallery/"><div>Gallery</div></a></li>
