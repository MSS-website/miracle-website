...
ul li a{
                ...
                <span class="icon-bar"></span>
						...
						<ul class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							...
							<li class="mega-menu"><a href="http://www.miraclesoft.com/careers/"><div>Careers</div></a>
								...
								<li class="mega-menu ">
								<a href="http://www.miraclesoft.com/events/"><div>Events</div></a>
						...
						<div class="head" id="cart1" onmouseover="cardToggle()">
							<a href="#" id="top-cart-trigger"><i class="fa fa-user"></i></a>
							</div>
							
							<div class="top-cart-content mega-menu-column" id="cart">
    ...
    <script>
    	...
    	<script type="text/javascript" src="../../NewFolder/js/jquery.1.js"></script>
	<script type="text/javascript" src="../../NewFolder/js/plugins.1.js"></script>
		<script type="text/javascript" src="../../NewFolder/js/functions.1.js"></script>
