...
<html>
	...
	<link rel="stylesheet" href="../../NewFolder/style.1.css" type="text/css" />
     ...
     <header id="header" class="transparent-header full-header page-section" data-sticky-class="not-dark">
			...
			<div id="header-wrap">
				...
				<div class=" clearfix">
					...
					============================================= -->
					<div id="logo">
						<a href="index.html" class="standard-logo" data-dark-logo="miracle-logo.svg" width="150px" height="70px"><img src="miracle-logo.svg" width="150px" height="70px"alt="Miracle Logo" style="margin-left:15px;"></a>
					...
					<nav id="primary-menu" style="padding-top:5px;">
						...
						<ul>
							...
							<li class="mega-menu"><a href="http://www.miraclesoft.com/careers/"><div>Careers</div></a>
								...
								<li><a href="http://www.miraclesoft.com/events/"><div class="head">Events</div></a>
								<ul class="head1">
