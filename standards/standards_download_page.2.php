        ...
        <section class="container">
            ...
            <div class="row">
             <div class="col-sm-12">
                 ...
                 <a href="../standards/Corporate_Standards_Miracle_v2.0.pdf.pdf"><button class="btn btn-primary btn-md" type="button">Download Corporate Standards and Guidelines Document</button></a><!-- Link the corporate standards PDF here -->
                 ...
                 <p class="methodText heavy">The Corporate Standards Packet conists of : </p>
                 <div class="row">
                     <div class="col-sm-5">
                         <ul>
                 ...
                 <div class="row">
                     <div class="col-sm-4">
                        ...
                        <a href="../standards/Corporate_Logos.zip"><button class="btn btn-primary btn-md" type="button">Download Now!! </button></a>
                     </div>
                     <div class="col-sm-4">
                         <p class="heavy greyText noMargin">Graphics</p>
                        ...
                        <a href="../standards/SAP_Business_Partner_Mark.zip"><button class="btn btn-primary btn-md" type="button">Download Now!! </button></a>
                     </div>
                     <div class="col-sm-4">
                         <p class="heavy greyText noMargin">Graphics</p>
                        ...
                        <a href="../standards/IBM_Business_Partner_Mark.zip"><button class="btn btn-primary btn-md" type="button">Download Now!! </button></a>
                     </div>
                 </div>
                 <hr>
                 <div class="row"><!-- Row #2 -->
                     <div class="col-sm-4">
                        ...
                        <a href="../standards/RedHat_Business_Partner_Mark.zip"><button class="btn btn-primary btn-md" type="button">Download Now!! </button></a>
                     </div>
                     <div class="col-sm-4">
                         <p class="heavy greyText noMargin">Graphics</p>
                        ...
                        <a href="../standards/Oracle_Business_Partner_Mark.zip"><button class="btn btn-primary btn-md" type="button">Download Now!! </button></a>
                     </div>
                     <div class="col-sm-4">
                        ...
                        <a href="../standards/Document_Templates.zip"><button class="btn btn-primary btn-md" type="button">Download Now!! </button></a>
                     </div>
                 </div>
                 <hr>
                 <div class="row"><!-- Row #3 -->
                     <div class="col-sm-4">
                        ...
                        <a href="../standards/Screen_Backgrounds.zip"><button class="btn btn-primary btn-md" type="button">Download Now!! </button></a>
                     </div>
                     <div class="col-sm-4">
                        ...
                        <a href="../standards/Corporate_Fonts.zip"><button class="btn btn-primary btn-md" type="button">Download Now!! </button></a>
                     </div>
                     <div class="col-sm-4">
                         <p class="heavy greyText noMargin">Template</p>
                        ...
                        <a href="../standards/Presentation_Templates.zip"><button class="btn btn-primary btn-md" type="button">Download Now!! </button></a>
                     </div>
                 </div>
                 <hr>
                 <div class="row"><!-- Row #4 -->
                     <div class="col-sm-4">
                        ...
                        <a href="../standards/Rally_Business_Partner_Mark.zip"><button class="btn btn-primary btn-md" type="button">Download Now!! </button></a>
                     </div>
                     <div class="col-sm-4">
                        <p class="heavy greyText noMargin">Graphics</p>
                        ...
                        <a href="../standards/HP_Business_Partner_Mark.zip"><button class="btn btn-primary btn-md" type="button">Download Now!! </button></a>
                     </div>
                     ...
                     <div class="col-sm-4">
                        ...
                        <a href="../standards/Pitney_Bowes_Business_Partner_Mark.zip"><button class="btn btn-primary btn-md" type="button">Download Now!! </button></a>
                     </div>
                      </div>
                       <div class="row"><!-- Row #5 -->
                     <div class="col-sm-4">
                        ...
                        <a href="../standards/Atlassian_Business_Partner_Mark.zip"><button class="btn btn-primary btn-md" type="button">Download Now!! </button></a>
                     </div>
                     </div>
                 </div>
             </div>
