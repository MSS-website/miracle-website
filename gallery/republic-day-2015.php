        ...
        <section class="container" id="about-us">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 text-left">
                   <h1 class="heavy">
                        <strong>Fight for a Cause</strong>
                    </h1>
                </div>
                <div class="col-sm-6 text-right">
                    <ul class="breadcrumb pull-right">
                        ...
                        <li class="active">Fight for a Cause
                        </li>
                    </ul>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                   <center>
                       <a data-flickr-embed="true"  href="https://www.flickr.com/photos/team_miracle/albums/72157650080772768" title="Republic Day - 2015">
                           <img src="https://c1.staticflickr.com/9/8660/16185459228_498743d851_b.jpg" width="1080" height="683" alt="Republic Day - 2015"></a>
