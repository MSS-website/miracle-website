  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" data-dismiss="modal">Check jobs</button>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <select class="form-control">
                                    <option>.NET,C#,ASP.NET,ADO.NET,WCF,VS 2012,VB.NET</option>
                                    <option>WINDOWS SERVERS(versions),POWERSHELL,ACTIVE DIRECTORY</option>
                                    <option>TIBCO BW,TIBCO AMX,TIBCO ADMIN</option>
                                    <option>STERLING INTEGRATOR / GENTRAN INTEGRATION SUIT,EDI</option>
                                    <option>ORACLE APPLICATION FINANCIAL, HRMS, CRM,SCM, TECHNICAL, ADMINISTRATOR, ORACLE FUSION</option>
                                    <option>SQL SERVER,SSRS,SSAS,SSIA</option>
                                    <option>MAINFRAMES, COBOL, CICS,VSAM,JMS, DB2</option>
                                    <option>BUSINESS ANALYST, METHODOLOGIES: OSDM, RUP, AGILE, SDM, USDM, WATERFALL</option>
                                    <option>SAP, NEWTEAVER</option>
                                </select>
                            </div>
                        </div>
                        <div class="row">
