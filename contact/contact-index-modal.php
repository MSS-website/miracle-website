...
" method="post">
  ...
  <div class="row">
    ...
    <button type="button" data-toggle="modal" data-target="#myModal"  class="btn btn-primary">Submit Details</button>  
    </div>
...
<center><p2> Your details have been submitted<p2><br><p3> We’ll be in touch shortly.</p3></center>
     ...
     <div class="col-sm-1"></div>
                ...
                <div class="row modal-footer noMargin">
                  ...
                  <div class="col-sm-12"> <button class="btn btn-primary col-sm-12" onclick="document.querySelector('#flip-toggle').classList.toggle('hover');"><strong>Explore Miracle </strong> <span> <i class="fa fa-arrow-right" ></i> </span></button></div>
              ...
              <div class="col-sm-1"></div>
                  ...
                  <div class="back" id="formDiv">
                   ...
                   <div class="row">
                       ...
                       <div class="col-sm-10">
                           <div class="modal-header">
                      <center>  <h3><strong> Leadership | Team Work | Innovation </strong></h3> </center>
                        <hr class="noMargin">
                     </div>
                    ...
                    <p class="methodText">
                        ...
                        <center><img src="http://www.miraclesoft.com/images/career/fresher-opportunities.png"></img>
                        <h3><strong>Fresher Opportunities</strong></h3>
                        </center>
                        <p class="methodText">
                        Miracle Institute for Leadership and Excellence (MILE) program is instigated to ensure that all our employees have the knowledge and skills necessitated to accomplish their tasks. MILE is a platform, which transmutes all Graduates into IT professionals with world-class training environment at Global standards. 
                           ...
                           <div class="modal-footer noMargin" >
                            <div class="row">
                          <div class="col-sm-12"><a href="http://www.miraclesoft.com/careers/"><button class="btn btn-primary col-sm-12"><strong>Check out Careers @ Miracle !! <strong></button></a></div>
                        </div>
                        </div>
                       </div>  <!--first tab ends-->
