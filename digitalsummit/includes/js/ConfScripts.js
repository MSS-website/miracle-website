...
function fieldLengthValidator(element) {
    ...
    /// alert("hai");
        if(element.id=="fname" || element.id=="lname" || element.id=="title" || element.id=="city" || element.id=="personName" || element.id=="email"|| element.id=="mname")
        {i=60;
        ...
        {i=500;
        }else if(element.id=='collegeName')
        {i=100;
