...
.btn-file{position:relative!important;overflow:hidden!important}
</style>
                ...
                <div class="row">
                    <div class="col-md-12">
                                ...
                                <form role="form" method="post" action="" accept-charset="UTF-8" enctype='multipart/form-data'>
                                    <div class="row">
                                        <div class="col-sm-12"> <h3><strong>Applicant Details</strong></h3></div>
                                     <div class="col-sm-4">                                            
                                         <select class="form-control" name="applyingFor" id="applyingFor" required="required">
                                                ...
                                                <option value="">Select Position1</option> 
                                                <option value="">Select Position2</option> 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <input type="text" id="mname" class="form-control" name="mname" placeholder="Middle Name" required="true" onchange="fieldLengthValidator(this);">
                                        </div>
                                        </div>
                                        <br>
                                        <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                              <h3><strong>Qualification</strong></h3></div>
                                        
                                        <div class="col-sm-3">
                                           
                                            <select class="form-control" id="graduation" name="graduation" required="required">
                                                <option value="" selected="selected" disabled="disabled">Graduation</option>
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <select class="form-control" id="postGraduation" name="postGraduation" >
                                                <option value="" selected="selected" disabled="disabled">Post Graduation</option>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">  <h3><strong>Experience</strong><small>&nbsp;(If any)</small></h3></div>
                                        <div class="col-sm-4">
                                            ...
                                            <span class="input-group-btn">
                                                <span class="btn btn-info btn-file">
                                                  ...
                                                  <input class="form-control" required="" type="file">
                                                            ...
                                                            <input class="form-control col-sm-2" placeholder=" Resume" readonly="" required="" type="text">
                                                    </div> 
