...
<html>
    <head>
        ...
        <style>
            ...
            .social-youtube{min-width:24px !important;}
            .social-linkedin{min-width:26px !important;}
        </style>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <ul class="footer-nav ul-breath list-unstyled">
                                ...
                                <li><a href="<?= url ?>/jobfair/job_fair.php">AP Cloud</a></li>
                                <li><a href="<?= url ?>#">MEANHack</a></li>
                                <li><a href="<?= url ?>#">Register for DS16</a></li>
 ...
 <h4 class="footer-heading">Contact&nbsp;Us</h4>
                        ...
                        <div class="col-sm-3">
                            <h4 class="footer-heading">Digital Job Fair</h4>
                            <ul class="footer-nav ul-breath list-unstyled">
                                <li><a href="<?= url ?>/jobfair/job_fair.php">PHP Developers</a></li>
                                <li><a href="<?= url ?>/jobfair/job_fair.php"> HR Managers</a></li>
                                <li><a href="<?= url ?>/jobfair/job_fair.php">System Administrators</a></li>
                                <li><a href="<?= url ?>#">Database Administrators</a></li>
                                <li><a href="<?= url ?>#">.NET Developers</a></li>
