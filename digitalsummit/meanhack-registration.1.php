...
<html lang="en">
    <head>
       ...
       <script src="../js/bootstrap.min.js"></script>
        <meta http-equiv="refresh" content="6; url=meanhack.php" />
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body"> 
         <p class="methodText">We had an enormous response for MEANHack registrations but were unfortunately only able to select 40 teams to participate in the final event. All the selected teams will be participating to try and win the top 3 cash prizes available. For all the teams that didn’t get selected, we will be conducting a lot more events in the future and hope to see you there. </p>
        </div>
