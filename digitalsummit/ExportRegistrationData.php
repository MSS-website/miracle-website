...
header('Content-Disposition: attachment; filename='.$filename);
 ...
 $Id = '';
            ...
            try {
                ...
                $queryString = "SELECT Id,FirstName,LastName,Email,MobileNumber,Title,AttendeeType,City,State,AreasOfInterest,Comments,CreatedDate,Country FROM tblConfRegistration";
