                    ...
                    <div class="col-sm-12 col-lg-12">
                        <div class="location_map col-sm-6" >
                            <h2   style="color:peachpuff">
                                Contact us <br><small>Feel free to contact us</small></h2>
                        </div>
                        <div class="location_map col-sm-6"> <img src="./images/banner/map.png" class="pull-right hidden-xs" alt="Third slide" style="width:250px"></div>
...
<!--                                        <strong>Miracle Software Systems, Inc.</strong><br>-->
                                        <div class="adress_block">
                                            ...
                                            <div class="update-nag  col-sm-12">
                                                ...
                                                <div class="update-text">  <a class="linkText" href="mailto:corporate@miraclesoft.com ">corporate@miraclesoft.com</a><br></div>
                                            </div>
...
<!--                                        <strong>Miracle Heights.</strong><br>-->
                                        <div class="adress_block">
                                            ...
                                            <div class="update-nag  col-sm-12">
                                                <div class="update-split">  <i class="fa fa-envelope-o" aria-hidden="true"></i></div>
                                                <div class="update-text">  <a class="linkText" href="mailto:offshore@miraclesoft.com">offshore@miraclesoft.com</a><br></div>
                                            </div>
