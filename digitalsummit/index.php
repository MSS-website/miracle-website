			...
			<div >
				<div id="cbp-qtrotator" class="cbp-qtrotator">
					...
					<div class="cbp-qtcontent">
						...
						<blockquote>
						 <p> <i class="fa fa-quote-left"></i> &nbsp;Digital transformation will not only force you to do different things, but also to do things differently. A couple of new business mantras need to be introduced and should become a part of everyoneâ€™s thinking. From today anything you do, anything you develop, anything you roll-out towards the market, should always be driven from a new set of basic rules that determine your view on the world from now on.</p>
						  <footer>Prasad Lokam
            ...
            <div class="container job_section">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="intro-text">
                        ...
                        <p class="skills"><i class="fa fa-quote-left" aria-hidden="true" style="color:#fff;"></i> <font color="#fff">&nbsp;Availing valuable job opportunities, <strong>Digital Summit Job fair ’16</strong> had geared up a huge young crowd. With over 5000 jobs being created, 20,000 people had attended the drive and opted for several jobs in various multinational companies.&nbsp;<i class="fa fa-quote-right" aria-hidden="true"></i></font></p>
                        <br>
