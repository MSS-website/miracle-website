...
class ConfMailManager {
    ...
    function sendConfRegistraintsDetails($fname,$lname,$email,$mobileNumber,$title,$attendeeType,$city,$state,$areasOfIntrest,$comments,$tempCountry){
	...
	$mail->AddReplyTo("corporate@miraclesoft.com", "Digital Summit 2016"); //reply-to address
	$mail->SetFrom("corporate@miraclesoft.com", "Digital Summit 2016"); //From address of the mail
...
<a href='http://www.miraclesoft.com/conf' target='_blank'><img alt='Logo' src='http://www.miraclesoft.com/conf/images/apcloud-Logo.png' width='165' height='auto' style='display: block; font-family: Helvetica, Arial, sans-serif; color: #ffffff; font-size: 16px;' border='0'></a></td></tr></table></td></tr>
 ...
 * 
 */
 function sendConfHackathonDetails($fname, $lname, $email, $mobileNumber, $city, $collegeName, $qualification, $branch, $passoutYear){
...
<tr><td style='padding: 5px 0 5px 0; font-size: 14px; line-height: 25px; font-family: calibri; color: #232527;' class='padding-copy'><b>Name:</b> $fname.$lname<br/>
							  ...
							  <b>Year of Passout:</b> $passoutYear<br/>
							  <b>City:</b> $city<br/>
							  </td></tr><tr></td>
<tr><td align='justify' style='padding: 5px 0 5px 0; border-bottom: 1px dashed #2368a0; font-size: 14px; line-height: 25px; font-family: calibri; color: #232527;' class='padding-copy'></td></tr></tr></table></td></tr>
<tr><td><table width='100%' border='0' cellspacing='0' cellpadding='0'><tr><td align='left' style='padding: 5px 0 5px 0; font-size: 14px; line-height: 22px; font-family: calibri; color: #8c8c8c; font-style: normal;' class='padding-copy'>Thanks & Regards,<br/><b>Digital Summit 2016,</b><br/><b> Miracle Software Systems, Inc. </b><br/><b>Email : corporate@miraclesoft.com </b><br/><b>Phone : 248-2331185</b><br/>
