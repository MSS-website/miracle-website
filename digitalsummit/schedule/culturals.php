...
<br>
            <div class="row">
                ...
                <div class="col-sm-4">
                    ...
                    <img src="../images/culturals/sing.png" width="150" height="150" class="img-responsive" alt="Thought Leadership" title="Thought Leadership">
                   <br> 
                ...
                <center>
                <div class="col-sm-4">
                    <img src="../images/culturals/dance2.png" width="150" height="150" class="img-responsive" alt="Thought Leadership" title="Thought Leadership">
                  <br>  
                ...
                <center>
                <div class="col-sm-4">
                    <img src="../images/culturals/dance.png" width="150" height="150" class="img-responsive" alt="Thought Leadership" title="Thought Leadership">
                   <br> 
            ...
            <div class="div">
                <div class="col-sm-12">
                    <center>
                    <div class="col-sm-4">
                         <img src="../images/culturals/dance1.png" width="150" height="150" class="img-responsive" alt="Thought Leadership" title="Thought Leadership">
                   <br> 
                   <h4 style="color:#0d416b"><strong> Dance </strong></h4> 
                    </div>
                    <div class="col-sm-4">
                         <img src="../images/culturals/mimicry.png" width="150" height="150" class="img-responsive" alt="Thought Leadership" title="Thought Leadership">
                   <br> 
                   <h4 style="color:#0d416b"><strong>Mimicry </strong></h4> 
                    </div>
                    <div class="col-sm-4">
                         <img src="../images/culturals/instrument.png" width="150" height="150" class="img-responsive" alt="Thought Leadership" title="Thought Leadership">
                   <br> 
