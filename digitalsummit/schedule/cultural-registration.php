...
<html lang="en">
  ...
  .parallax{
                background-image:url('images/culturals/cultural-res.jpg');
    ...
    <?php } else { ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <h3 style="color:#00aae7;"> <strong>Cultural Competition Registration</strong></h3>
                                    ...
                                    <!--                                    <div class="col-sm-12">
                                     ...
                                     <br>
                                        <div class="row">
                                           ...
                                           <div class="col-sm-4">
                                               <div  class="btn-group">
                                                    <button type="button" class="btn btn-info" id="btnSubmit" name="btnSubmit" value="Submit">Register</button> 
                                                </div>
                                           </div>
