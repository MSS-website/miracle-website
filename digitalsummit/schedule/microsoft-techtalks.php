									...
									<div class="modal-content">
										...
										<div class="modal-body ">
											<div class="row">
												...
												<div class="col-sm-4">
													<center>
													<img src="<?= url ?>/images/schedule/Ritesh-modi.png" class="wpx-100   mgb-20" title="" alt="" data-edit="false" data-editor="field" data-field="src[Image Path]; title[Image Title]; alt[Image Alternate Text]">
														<h5 class="font-cond mgb-5 fg-text-d fs-130" contenteditable="false">Sr. Technical Evangelist</h5>
														<h5 class="font-cond mgb-5 fg-text-d fs-130" contenteditable="false">Microsoft</h5>
													</center>
													</div>
								...
								<div class="col-sm-6">
									<div class="session-details col-sm-12" style="border:0">
										<br>
											...
											<br>
											<p>The <strong>Internet of Things (IoT)</strong> is a key building block for digital business. Every organization wish to be ahead of the curve by the virtue of Product and Process Innovation. Today with the help of IoT and Cloud - one can not only collect the data but can make it intelligent by applying Predictive Analytics and cognitive services for Business innovation. </p>
										</div>
									</div>
							
									<div class="col-sm-3">
									    <center>
											<img data-toggle="modal" data-target="#myModal1" src="<?= url ?>/images/schedule/Prabhajhot-singh.png" class="wpx-100   mgb-20" title="" alt="" data-edit="false" data-editor="field" data-field="src[Image Path]; title[Image Title]; alt[Image Alternate Text]">
												<h5 class="font-cond mgb-5 fg-text-d fs-130" contenteditable="false">
												...
												<div class="modal-content">
													...
													<div class="modal-body ">
														<div class="row">
															...
															<div class="col-sm-4">
																<center>
																<img src="<?= url ?>/images/schedule/Prabhajhot-singh.png" class="wpx-100   mgb-20" title="" alt="" data-edit="false" data-editor="field" data-field="src[Image Path]; title[Image Title]; alt[Image Alternate Text]">
																	<h5 class="font-cond mgb-5 fg-text-d fs-130" contenteditable="false">Regional Director and Azure MVP</h5>
																	<h5 class="font-cond mgb-5 fg-text-d fs-130" contenteditable="false">Microsoft</h5>
															</center>
																</div>
										...
										<div class="row">
											...
											<div class="row">
												...
												<div class="row">
													<div class="col-sm-3"></div>
													<div class="col-sm-6">
														<div class="methodText">Containers have been there for long and quite ubiquitous in Linux world. They are part of core Linux kernel. They were adopted but the real adoption started with the advent of Docker. Docker make containers accessible to developers, operations and to the enterprises. So much so, Windows Server 2016 has recently launched and it brings along with it some revolutionary paradigm features that will change the way environment and applications are deployed, managed and operated in windows world. Containers are one among them. Containers have swept the entire industry and is one of the hottest buzzword. Every CIO wants to hear about containers and how they can help in making their applications more agile, flexible and reduce their cost of operations and availability. In this session, We understood the evolution of Containers. The tools and services available from Service providers, vendors and partners. Furthermore, how containers are changing the face of DevOps were also discussed in this session.</div>
													</div>
													<div class="col-sm-3">
														<center>
															<img data-toggle="modal" data-target="#myModal2" src="

																									
																<?= url ?>/images/schedule/Ritesh-modi.png" class="wpx-100   mgb-20" title="" alt="" data-edit="false" data-editor="field" data-field="src[Image Path]; title[Image Title]; alt[Image Alternate Text]">
																<h5 class="font-cond mgb-5 fg-text-d fs-130" contenteditable="false">
																	<strong>Ritesh Modi</strong>
																</h5>
																<h5 class="font-cond mgb-5 fg-text-d fs-130" contenteditable="false">Sr. Technical Evangelist</h5>
																...
																<div class="modal-content">
																	...
																	<div class="modal-body">
																		<div class="row">
																			...
																			<div class="col-sm-4">
																				<center>
																					<img src="../images/schedule/abhijit.jpg" class="wpx-100   mgb-20" title="" alt="Abhjit" data-edit="false" data-editor="field" data-field="src[Image Path]; title[Image Title]; alt[Image Alternate Text]">
																						<h5 class="font-cond mgb-5 fg-text-d fs-130" contenteditable="false">Emerging Capabilities – HoloLens</h5>
																						<h5 class="font-cond mgb-5 fg-text-d fs-130" contenteditable="false">Microsoft(Former MVP)</h5>
																					</center>
																				</div>
															...
															<!--Modal End-->
																					...
																					<div class="row">
																						...
																						<div class="row">
																							...
																							<div class="col-sm-9">
                                                                                              <div class="session-details col-sm-12" style="border:0">
                                                                                                <br> <a href="http://www.miraclesoft.com/digitalsummit/schedule/culturals.php"><h4><strong>Hungama@Digital Summit ’16 Day #2</strong></h4></a> 
