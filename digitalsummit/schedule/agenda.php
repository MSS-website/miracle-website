        ...
        <div class="container">
                    ...
                    <div class="greyback1">
                       <center>
                        <div class="col-sm-12">
                         ...
                         <div class="col-sm-4"><img src="../images/profile_pics/ganta.png" height="100" width="100"><br><b>Shri G.Srinivasa Rao </b><br> HR Development Minister, AP</div>
                         </div>
                         <div class="col-sm-12">
            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    ...
                    <br>
                    <div class="methodText">An invite only event for NRIs and Miracle Customers from the US - this event brought many IT experts and leaders who showcased the talent of AP, the need for digital transformation, and why Visakhapatnam is the best choice for them. </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    ...
                    <h4 style=" margin-top:25px;"><strong><font color="#00aae7">Hungama@Digital Summit 2015 Day #1 </font></strong></h4></a>
                    <a href="summit-venues.php">
                        <h4 class="location-head"><i>@ AU Convocation Hall(Andhra University)</i></h4>
                    </a>
                    <div class="methodText">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="greyback1">
                                    ...
                                    <br>
                                    <div class="methodText"><strong>Day #2</strong> at <strong>Digital Summit</strong> hosted leaders and speakers from Microsoft as we deep dive into Azure and its offerings around <strong>Digital Transformation!</strong> Live Bot Demos, industry view of Digital Transformation and more at <strong>DS16</strong></div>
                                    <div class="row session-heading-g">
                                        <div class="col-sm-12"></div>
                                    </div>
                                    <a href="../TechTalks/microsoft-techtalks.php">
                                    ...
                                    <br>
                                    <div class="methodText">From DevOps to the Internet of Things, up to the cloud and about the next age of servers – <strong>Day #2</strong> of the <strong>Technical Talks</strong> at <strong>Digital Summit</strong> was having it all with 5 great speaker sessions lined up for you. Our partner <strong>Microsoft</strong> explained about their view of a beautiful digital future.</div>
                                    <div class="row session-heading-g">
                                        <div class="col-sm-12"></div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="greyback1">
                                    ...
                                    <br>
                                    <div class="methodText">Flying drones from the cloud is just the start of a new world in which the gap between the physical and digital world shrinks. We welcomed <strong>IBM</strong> to the party at <strong>Digital Summit 2016</strong> with an enthralling keynote full of live demos and eminent speakers.</div>
                                    <div class="row session-heading-g">
                                        <div class="col-sm-12"></div>
                                    </div>
                                    <a href="../TechTalks/IBM-innovation-summit.php">
                                    ...
                                    <br>
                                    <div class="methodText"><strong>IBM</strong> is a leader in IT, a giant if you should say – and they’ve seen it all, from the typewriter to the digital transformation of today. So they explained us about the way the world is changing! From how can an IoT solution be built for a manufacturing plant to the cognitive solution capabilities of Watson, <strong>Day #3</strong> had it all!</div>
                                    <div class="row session-heading-g">
                                        <div class="col-sm-12"></div>
                                    </div>
