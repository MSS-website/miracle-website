                ...
                <?php	if($currEventType==1) {?>
                        ...
                        <li class="active">
                        	<?php } else { ?>
                        	 <li>
                        	 	<?php } ?>
                            <a data-toggle="tab" href="#two" onclick="enableDiv(2);"><h4><strong>Hungama</strong></h4></a>
                        </li>
                       ...
                       <?php	if($currEventType==4) {?>
                        <li class="active">
                        	<?php } else { ?>
                        	 <li>
                        	 	<?php } ?>
                            <a data-toggle="tab" href="#four" onclick="enableDiv(4);"><h4><strong>Innovation Summit</strong></h4></a>
                        </li>
                        ...
                        <li class="active">
                        	<?php } else { ?>
                        	 <li>
                        	 	<?php } ?>
                            <a data-toggle="tab" href="#five" onclick="enableDiv(5);"><h4><strong>Business Summit</strong></h4></a>
                        </li>
                        ...
                        <li class="active">
                        	<?php } else { ?>
                        	 <li>
                        	 	<?php } ?>
                            <a data-toggle="tab" href="#six" onclick="enableDiv(6);"><h4><strong>TechTalk</strong></h4></a>
                        </li>
                    </ul>
                    <div class="tab-content">
                       ...
                       <?php 
                        	...
                        	include 'Galleryinnovationsummit.php';
                        }
                       else { ?>
