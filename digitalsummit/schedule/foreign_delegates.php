                ...
                <div class="row">
                    <div class="col-sm-12 col-lg-12">
                        <div class="location_map col-sm-6">
                            <h2 style="" class="">Foreign Delegates<br><small>Planning for the trip</small></h2>
                        </div>
                        <div class="location_map col-sm-6"> <img class="pull-right hidden-xs" style="width: 230px;" alt="meeting" src="../images/meeting-1184892_1280.gif"></div>
                        ...
                        <div class="col-md-10 cta-button">
                            ...
                            <div  class="box_layout">
                                <div>
                                    ...
                                    <a target="_blank" href="<?= url ?>/registration.php">     Click Here To Register  for Digital Summit 2016 </a>
