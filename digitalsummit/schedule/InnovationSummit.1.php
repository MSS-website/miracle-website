...
<section class="parallax">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                      <div class="session-details col-sm-12" style="border:0">
                       ...
                       <div class="methodText"><br> <p class="methodText">Any developer, any platform : Microsoft’s commitment to openness and collaboration is ingrained in our day-to-day approach to doing business alongside industry partners around the world, including open source communities. The Microsoft cloud supports a wide range of industry leading operating systems, languages, tools, and frameworks. It puts the best of Windows and Linux ecosystems at your fingertips, to help build great applications and services that work with many devices. For a developer, there are so many things that the MS Cloud offers. Most of the tools are free for student developers.</p>
 ...
 <img src="<?= url ?>/images/schedule/Aditya.png" class="wpx-100   mgb-20" title="" alt="" data-edit="false" data-editor="field" data-field="src[Image Path]; title[Image Title]; alt[Image Alternate Text]">
</div>
