...
<section class="parallax">
        ...
        <div class="container">
            <div class="row" >
                ...
                <div class="col-sm-12">
                    <p class="methodText">
             <br> Its day #1 at Digital Summit, and innovation is bubbling in Visakhapatnam! Come and join us for the opening keynote where you will see how technology is changing the world. <strong>Innovation Summit @ Digital Summit 2016</strong> will offer many professionals and executives as speakers around Cloud, Cognitive, DevOps, IoT and more from Microsoft, Oracle, IBM, and Miracle. Learn about Microsoft’s BizSpark Program, Oracle’s Cloud Journey and how to push your first MEAN Applications to IBM Bluemix. This is the beginning and it is going to be awesome :)
            </p>
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                      <div class="session-details col-sm-12" style="border:0">
                        <br>  <h4><strong>Introduction to Microsoft Azure</strong></h4>
                  ...
                  <div class="col-sm-3">
                   <center>
                     ...
                     <img data-toggle="modal" data-target="#myModal4" src="<?= url ?>/images/schedule/user-1.png" class="wpx-100   mgb-20" title="" alt="" data-edit="false" data-editor="field" data-field="src[Image Path]; title[Image Title]; alt[Image Alternate Text]">
                    </center>
                    <center>
                    <h5 class="font-cond mgb-5 fg-text-d fs-130" contenteditable="false"><strong>Usha Ratnavel </strong></h5>
        ...
        <div class="modal-footer nomargintop">
          <button type="button" class="btn btn-info" data-dismiss="modal">Close</button>
            ...
            <div class="col-sm-12">
                ...
                <div class="row">
                    <div class="col-sm-3">
                     <h5 class="time_strip"><strong> 11:30AM&ndash;1:00PM </strong></h5>   
                    </div>
                  ...
                  <div class="col-sm-6">
                      <div class="session-details col-sm-12" style="border:0">
                       ...
                       <div class="methodText">
                       <br> Hybrid Integrations with Azure Logic Apps. We will look at leveraging Logic Apps in a hybrid scenario, where the business process needs to integrate systems in cloud and on-premise. Logic apps can play a significant role in automating business processes that span across both cloud-based and on-premise systems.
                  </div>
                 </div>
                 </div>
            ...
            <div class="col-sm-12">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                      ...
                      Agile teams are expected to provide a potentially releasable software increment to the working product at the end of each iteration. This can only be achieved if the different parts of code developed by each team member are integrated with each other and deployed on the environment where they can be tested. This cycle of coding – integration – deployment – testing should happen frequently, may be even multiple times in a day. Microsoft VSTS provides automation of these activities so that code is continuously integrated and then automatically deployed for testing. In this session Subodh will discuss and demonstrate various features of Microsoft VSTS that support the Continuous Integration – Continuous Deployment of software on Azure resources.   
                  </div>
                 </div>
                 </div>
                ...
                <div class="col-sm-3 ">
                   <center>
                     <img data-toggle="modal" data-target="#myModal4" src="../images/schedule/sohoni.jpg" class="wpx-100   mgb-20" title="" alt="" data-edit="false" data-editor="field" data-field="src[Image Path]; title[Image Title]; alt[Image Alternate Text]">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                      <div class="session-details col-sm-12" style="border:0">
                       ...
                       <br> <p class="methodText">Abstract - TBD</p>
