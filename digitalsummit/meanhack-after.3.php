...
.greyback1{
    ...
    <body class="home">
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
               <p class="methodText">
                    <strong>Bring out the innovator in you - 30 Teams, 24 hours, 15 mentors, 3 ideas, and 1 winner!</strong> Do you have what it takes to be crowned the Best Digital Innovation Team at Digital Summit 2016? Join us at <strong>MEANHack ’16 </strong>which will be a unique 24 hour hack-a-thon, where 30 students teams will compete against one another to become the best. The event will focus around Cloud and MEAN Stack technologies, where students will have to learn and create a working prototype of one of the 3 ideas that Miracle gives them. The ideas will be focussed on Mobility, Internet of Things, Cloud Computing and Cognitive. 
                </p><br> 
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12">
               ...
               <a data-toggle="modal" data-target="#myModal" ><button type="button" class="btn btn-info col-sm-12">Check out the final select teams!</button></a>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header greyback1">
          <h4 class="modal-title"> <strong>The Final 40 Teams!</strong></h4>
        </div>
        <div class="modal-body ">
          <div class="row">
            ...
            <div class="col-sm-12">
               <p class="methodText">
                    We had an enormous response for <strong> MEANHack registrations</strong> but were unfortunately only able to select 40 teams to participate in the final event. All the selected teams will be participating to try and win the top 3 cash prizes available. For all the teams that didn’t get selected, we will be conducting a lot more events in the future and hope to see you there.  
                </p><br> 
            </div>
        </div>
         <div class="row">
            <div class="col-sm-12">
               ...
               <center><a href="https://www.youtube.com/watch?v=M_l5XCnmns0&index=1&list=PLHpWKO44gK4YcvK9rKGDQaMdlO__bZdxu" target="_blank" ><button type="button" class="btn btn-info col-sm-12">Access Training Material</button></a></center>
            </div>
                ...
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                         <tr>
                            ...
                            <td>Nidhi, Prasanna, Sneha and Monaleesa</td>
                            <td>Avanthi Institute of Engineering and Technology</td>
                            <td>Internet of Things</td>
                            <td>Vizianagaram</td>
                        </tr>
                        <tr>
                            <td>3</td>
                             <td>SaiKrishna, Mahesh and Sirisha </td>
                            <td>BVC College of Engineering</td>
                            <td>Cognitive Chat Bots</td>
                            <td>Rajamundry</td>
                        ...
                        <tr>
                            <td>7</td>
                            <td>Vijayalakshmi, RosiPratyusha,and Kalyani </td>
                        ...
                        <tr>
                            <td>9</td>
                           <td>Viswa, Jyothi and Bharadwaj</td>
                            <td>Kakinada Institute of Engineering Technology</td>
                            <td>Cognitive Chat Bots</td>
                            <td>Kakinada</td>
                        </tr>
                        <tr>
                            <td>11</td>
                            <td>Shiva, Madhu, Sruthi and Bhargavi  </td>
                            <td>ANITS</td>
                            <td>Enterprise Mobility</td>
                            <td>Visakhapatnam</td>
                        ...
                        <tr>
                            ...
                            <td>Krishnaveni, Srujana, Parvathi and Lalitha</td>
                            <td>D.M.S.S.V.H College of Engineering</td>
                            <td>Cognitive Chat Bots</td>
                            <td>Machilipatnam</td>
                        </tr>
                        <tr>
                            ...
                            <td>Durga Prasad, Sowthik,Venu and Mukesh </td>
                            <td>Bapatla Engineering College</td>
                            <td>Internet of Things</td>
                            <td>Bapatla</td>
                        ...
                        <tr>
                            ...
                            <td>Durga rao, Balaji, Riyaz and Kiran </td>
                        ...
                        <tr>
                            ...
                            <td>Chinnari, Pushpalatha, Lakshmi and Gopesh </td>
                            <td>Indo American</td>
                            <td>Cognitive Chat Bots</td>
                            <td>Visakhapatnam</td>
                        </tr>
                        <tr>
                            ...
                            <td>Manikanta, Arjun and Dhawal</td>
                            <td>JNTUK-UCEV</td>
                            <td>Enterprise Mobility</td>
                            <td>Vizianagaram</td>
                        </tr>
                         <tr>
                            ...
                            <td>Satyanarayana, Raja and Kiran</td>
                            <td>Kakinada Institute of Engineering and Technology</td>
                            <td>Internet of Things</td>
                            <td>Kakinada</td>
                        </tr>
                        <tr>
                            ...
                            <td>Pavan, Vinay, Sampath and Srinivas</td>
                            <td>Bapatla Engineering College</td>
                            <td>Cognitive Chat Bots</td>
                            <td>Bapatla</td>
                        ...
                        <tr>
                            ...
                            <td>Rama rao, Prathyusha and Sowmya</td>
                        ...
                        <tr>
                            ...
                            <td>Arun, Tharun, Raghu and Rohit </td>
                        ...
                        <tr>
                            <td>31</td>
                           <td>Leela, Krishna, Amrutha and Sruthi</td>
                            <td>St.Ann's College of Engineering and Technology</td>
                            <td>Enterprise Mobility</td>
                            <td>Chirala</td>
                        </tr>
                        <tr>
                            <td>33</td>
                            <td>Srikanth. Prabhakar, Dinesh and Jitendra</td>
                        ...
                        <tr>
                            ...
                            <td>Abhishek, Kumar, Suman and Raviteja</td>
                        ...
                        <tr>
                            ...
                            <td>Prabu, Dinesh, Mani Kiran and mallikarjun</td>
                        ...
                        <tr>
                            <td>39</td>
                             <td>Harish, Srikanth, Balu and Sai lakshmi</td>
                            <td>Gayatri vidya parishad school of engineering</td>
                            <td>Internet of Things</td>
                            <td>Visakhapatnam</td>
                        </tr>
                        <tr>
                            ...
                            <td>Prashanth, Karthik and Vivek </td>
                            <td>MVGR College of Engineering</td>
                            <td>Cognitive Chat Bots</td>
                            <td>Vizianagaram</td>
                ...
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Samad, Koteswari, Madhavi and Mounika</td>
                            <td>St.Ann's College of Engineering and Technology</td>
                            <td>Cognitive Chat Bots</td>
                            <td>Chirala</td>
                        </tr>
                        <tr>
                            ...
                            <td>Sarath, Kalyan, phani and Sandeep</td>
                            <td>NRI Institute of Technology</td>
                            <td>Internet of Things</td>
                            <td>Vijayawada</td>
                        ...
                        <tr>
                            ...
                            <td>Omsai, Krishna Vamsi, Siveshwararao and Sandya </td>
                            <td>BVCITS </td>
                            <td>Enterprise Mobility</td>
                            <td>Amalapuram</td>
                        ...
                        <tr>
                            ...
                            <td>Supriya, Suhitha, Krishnaveni and Neha</td>
                            <td>Dr.Lankapalli Bullaya College Of Engineering (Womens)</td>
                            <td>Enterprise Mobility</td>
                            <td>Visakhapatnam</td>
                        </tr>
                        <tr>
                            <td>10</td>
                            <td>Uday, Uday allu and Neeramani </td>
                            <td>Miracle Educational Society </td>
                           <td>Cognitive Chat Bots</td>
                            <td>Vizianagaram</td>
                        </tr>
                        <tr>
                            ...
                            <td>Manikanta swamy, Ajay, Pujitha and Thrisandya </td>
                            <td>BVC College of Engineering</td>
                            <td>Enterprise Mobility</td>
                            <td>Amalapuram</td>
                        ...
                        <tr>
                            ...
                            <td>Supriya, Bhavya, Anusha and Sirisha </td>
                        ...
                        <tr>
                            <td>16</td>
                            <td>Subramanyam, Pavan and Durgarao </td>
                            <td>RGUKT- IIIT </td>
                            <td>Enterprise Mobility</td>
                            <td>Nuzvid</td>
                        </tr>
                        <tr>
                            <td>18</td>
                            <td>Pavan, Ramanuj, Manoj and Prashanth </td>
                            <td>Miracle Educational Society </td>
                            <td>Internet of Things</td>
                            <td>Vizianagaram</td>
                        ...
                        <tr>
                            <td>20</td>
                            <td>Sandya, Bharathi,Lakshmi and Abhishek </td>
                            <td>BVCITS</td>
                            <td>Internet of Things</td>
                            <td>Amalapuram</td>
                         ...
                         <tr>
                            <td>22</td>
                             ...
                             <td>Ramcharan, Srikanth, Sai Adithya and Gayathri </td>
                            <td>Sri Vasavi Engineering College</td>
                            <td>Internet of Things</td>
                            <td>Tadepalligudem</td>
                        </tr>
                        <tr>
                            <td>24</td>
                            <td>Chandrashekar, Srilatha, Sowjanya and Brunda </td>
                            <td>Miracle Educational Society </td>
                            <td>Internet of Things</td>
                            <td>Vizianagaram</td>
                        ...
                        <tr>
                            <td>26</td>
                            <td>Basha, Anil, Shahid and Shabbir</td>
                            <td>RVR&JC College of Engineering </td>
                            <td>Cognitive Chat Bots</td>
                            <td>Guntur</td>
                        </tr>
                        <tr>
                            <td>28</td>
                            <td>Vamsi, Karun and Jayachandra </td>
                            <td>BVC College of Engineering</td>
                            <td>Internet of Things</td>
                            <td>Rajamundry</td>
                        </tr>
                        <tr>
                            <td>30</td>
                            <td>Dhanekula, Poojitha and Supriya</td>
                            <td>Dr Lankapalli Bullaya College of Engineering for women</td>
                            <td>Cognitive Chat Bots</td>
                            <td>Visakhapatnam</td>
                        </tr>
                        <tr>
                            <td>32</td>
                            <td>Prashanthi, Ganesh, Gayathri and Devi </td>
                            <td>Miracle Educational Society </td>
                            <td>Cognitive Chat Bots</td>
                            <td>Vizianagaram</td>
                        ...
                        <tr>
                            <td>34</td>
                              <td>Sai Krishna, Teja sri and Sai Saran </td>
                            <td>Vasireddy Venkatadri College of Technology </td>
                            <td>Internet of Things</td>
                            <td>Guntur</td>
                        ...
                        <tr>
                            <td>36</td>
                            <td>Satya Usha, Harika and Devi </td>
                            <td>BVC College of Engineering </td>
                            <td>Internet of Things</td>
                            <td>Odalarevu</td>
                        </tr>
                        <tr>
                            <td>38</td>
                            <td>Chandramouli, Sailesh, Mujahid and Gopi </td>
                            <td>Gudlavalleru Engineering College</td>
                            <td>Cognitive Chat Bots</td>
                            <td>Gudlavalleru</td>  
                        </tr>
                        <tr>
                            <td>40</td>
                            <td>Usha, Srujana, Divya and Padma </td>
                            <td>Miracle Educational Society </td>
                            <td>Cognitive Chat Bots</td>
                            <td>Vizianagaram</td>
                        ...
                        <tr>
                            <td>42</td>
                           <td>Monica, Anuja, Priya Darshini and Roshitha </td>
                            <td>D.M.S.S.V.H College of Engineering</td>
                            <td>Enterprise Mobility</td>
                            <td>Machilipatnam</td>
                        </tr>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <p class="methodText">
                   <strong> MEANHack ’16 </strong>will be held at Miracle Heights, Rushikonda which is Miracle’s APAC HQ. Situated on a beautiful hill, with a beautiful view of the Bay of Bengal, you will be treated with a free-style and innovation-encouraging environment. You can choose your area in the location to work, make sure to choose the best for your team! Your lunch, snacks, dinner and more will all be provided by Miracle and we will try and add some fun and games as well to the work. While your dress code is up to you, please do ensure that you wear something that is comfortable and unobtrusive to others in the area. We would like to provide a harassment free area for all the attendees, any negligence to this code of conduct will be treated with punishment.
                </p>
               
                <p class="methodText">
                    The top 3 teams with the best implementation of the ideas will be awarded and recognized, with Miracle sponsoring over 1 Lakh rupees which are to be won in cash prizes.
                </p>
              ...
              <h4 style="color:#0d416b"><strong>Selection Process Timeline </strong></h4>
                <p class="methodText">
                    ...
                    <ul>
                    <li>Registrations Open – November 18th, 2016 </li>
                    <li>What is MEANHack? Video Release – November 22nd, 2016 </li>
                    <li>Registrations Close – November 30th, 2016</li>
                    <li>Final 30 Teams Announced – December 1st, 2016 </li>
                    <li>Training Material Provided to Teams – December 2nd, 2016 </li>
                    <li>Webinar for Team Questions/Information – December 6th, 2016</li>
                    <li>Teams meet and compete at MEANHack ’16 – December 16th, 2016 </li>
                    </ul>
    ...
    <div class="inner">
      ...
      <div class="row">
          <div class="col-sm-12">
              ...
              <p> While the actual implementation idea will be presented to the students on the day of the event, the technology track is up to you to select. Note that the technology tracks are first-come-first-server so make sure that you select the right track quickly. Each track will have a unique Miracle problem that will be given to you on December 16th during the event.</p>
          </div>
      </div>
                 <div class="row">
                ...
                <div class="col-sm-4">
                        <br>
                           ...
                           <center><h5>Come and build a mobile application that will help Miracle’s Employee interact with facilities teams better through technology. This track will involve technologies such as Ionic, Angular, Sockets, Node JS, Cloudant and more.</h5></center>
                ...
                <div class="col-sm-4">
                          ...
                          <center> <h4 style="color:#0d416b"><strong>Cognitive Computing</strong></h4> </center>
                            ...
                            <center><h5>Come and build a chat bot that will change the way that Miraclites interact with the Innovation Labs team for tasks. This track will involve technologies such as Watson, Node JS, Sockets, APIs, Cloudant, IBM Bluemix and more.</h5></center>
                           <br>
                ...
                <div class="col-sm-4">
                     <br> 
                          ...
                          <center> <h4 style="color:#0d416b"><strong>Connected Solutions</strong></h4> </center>
                           ...
                           <center><h5>Come and build a solution that will help Miracle’s Bus Schedule optimization with the help of RFID technology and a very cool dashboard. This track will involve technologies such as Angular, Sockets, Node JS, RFID, IBM Bluemix and more.</h5></center>
            </div>
            </div>
           <div class="row">
               <div class="col-sm-12">
