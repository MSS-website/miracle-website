...
header('Content-Disposition: attachment; filename='.$filename);
 ...
 $Id = '';
            ...
            try {
                ...
                $queryString = "SELECT Id,FirstName,LastName,MiddleName,Email,MobileNumber,FileName,ResumePath,SkillSet,Comments,CreatedDate,RandomKey,ApplyingFor FROM tblConfApplicant";
...
$count=0;
		...
		<tr valign="center">
			...
			<td valign="center">' . $LastName . '</td>
                            ...
                            <td valign="center">' . $ApplyingFor . '</td></tr>';
