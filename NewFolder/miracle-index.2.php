...
h2 { font-size: 64px !important; color:#232527 !important; }
	...
	<header id="header" class="transparent-header full-header page-section" data-sticky-class="not-dark">
			...
			<div id="header-wrap">
				...
				<div class=" clearfix">
					...
					<!-- Primary Navigation
					============================================= -->
					<nav id="primary-menu" style="padding-top:10px;">
						...
						<ul>
							...
							<li class="mega-menu"><a href="#"><div>Company</div></a>
								<div class="mega-menu-content style-2 clearfix">
									...
									<ul class="mega-menu-column col-md-4">
										<li class="mega-menu-title"><a href="http://www.miraclesoft.com/contact/"><div>Reach Out</div></a>
											<ul>
							...
							<li class="mega-menu"><a href="#"><div>Our Services</div></a>
								<div class="mega-menu-content style-2 clearfix">
									<ul class="mega-menu-column col-md-4">
										<li class="mega-menu-title"><a href="#"><div>Services</div></a>
											<ul>
									...
									<ul class="mega-menu-column col-md-4">
										<li class="mega-menu-title"><a href="#"><div>Technologies</div></a>
											<ul>
									...
									<ul class="mega-menu-column col-md-4">
										<li class="mega-menu-title"><a href="#"><div>Industries</div></a>
											<ul>
							...
							<li class="mega-menu"><a href="#"><div>Careers</div></a>
								<div class="mega-menu-content style-2 clearfix">
									...
									<ul class="mega-menu-column col-md-4">
										<li class="mega-menu-title"><a href="#"><div>Fresher's</div></a>
											<ul>
									...
									<ul class="mega-menu-column col-md-4">
										<li class="mega-menu-title"><a href="#"><div>Programs</div></a>
											<ul>
								...
								<div class="mega-menu-content style-2 clearfix">
							        ...
							        <li class="mega-menu"><a href="#"><div>Sign In</div></a>
								<div class="mega-menu-content style-2 clearfix">
									<ul class="mega-menu-column col-md-4">
										<li class="mega-menu-title"><a href="#"><div></div></a>
											<ul>
												<li><a href="https://www.miraclesoft.com/Hubble/customer/login.action"><div>Customer Login</div></a></li>
										...
										<li class="mega-menu-title"><a href="#"><div></div></a>
											<ul>
												...
												<li><a href="https://www.miraclesoft.com/Hubble/"><div>Employee Login</div></a></li>
										...
										<li class="mega-menu-title"><a href="#"><div></div></a>
											<ul>
												...
												<li><a href="http://www.miraclesoft.com/services/project-management-offerings/#"><div>Partner Login</div></a></li>
		...
		<section id="slider" class="slider-parallax full-screen force-full-screen with-header swiper_wrapper page-section clearfix slider-parallax-visible" >
			...
			<div class="" style="transform: translateY(0px);">
				...
				<div class="swiper-container swiper-parent swiper-container-horizontal" style="cursor: -webkit-grab;">
					<div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
						<div class="swiper-slide dark swiper-slide-active" style="background-image: url(&quot;images/slider/swiper/1.jpg&quot;); height: 494px; width: 1263px;">
							<div class="container clearfix">
								<div class="slider-caption slider-caption-center" style="transform: translateY(0px); opacity: 1; top: 164px;">
									<h2 data-caption-animate="fadeInUp" class="fadeInUp animated">Welcome to Canvas</h2>
									<p data-caption-animate="fadeInUp" data-caption-delay="200" class="fadeInUp animated">Create just what you need for your Perfect Website. Choose from a wide range of Elements &amp; simply put them on our Canvas.</p>
									<center><button type="button" class="btn btn-transparent btn-lg">Submit</button></center>
								</div>
							</div>
						</div>
					
							<div class="swiper-slide dark swiper-slide-active" style="background-image: url(&quot;images/slider/swiper/2.jpg&quot;); height: 494px; width: 1263px;">
							<div class="container clearfix">
								<div class="slider-caption slider-caption-center" style="transform: translateY(0px); opacity: 1; top: 164px;">
									<h2 data-caption-animate="fadeInUp" class="not-animated">Beautifully Flexible</h2>
									<p data-caption-animate="fadeInUp" data-caption-delay="200" class="not-animated">Looks beautiful &amp; ultra-sharp on Retina Screen Displays. Powerful Layout with Responsive functionality that can be adapted to any screen size.</p>
								</div>
							</div>
							</div>
					
					
						<div class="swiper-slide" style="background-image: url(&quot;images/slider/swiper/3.jpg&quot;); background-position: center top; height: 494px; width: 1263px;">
							<div class="container clearfix">
								<div class="slider-caption" style="transform: translateY(0px); opacity: 1; top: 127px;">
									<h2 data-caption-animate="fadeInUp" class="not-animated"><font color="#232527">Great Performance</font></h2>
									<p data-caption-animate="fadeInUp" data-caption-delay="200" class="not-animated"><font color="#232527">You'll be surprised to see the Final Results of your Creation &amp; would crave for more.</font></p>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="container clearfix">
					...
					<nav class="one-page-menu">
						<ul>
							...
							<li><a href="#" data-href="#section-principles" class="no-offset"><div>Principles</div></a></li>
		...
		<section id="section-events">
				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="feature-box center media-box fbox-bg">
							<center><div class="fbox-media">
								<a href="http://www.miraclesoft.com/events/webinar-before.php?eventId=214"><img class="image_fade"  src="images/userdefined/6.png" alt="Featured Box Image"></a>
							</div></center>
							<div class="fbox-desc">
								<h3><font color="#777">Exploring DataPower </font></h3>
							</div>
						</div>
					</div>
						<div class="col-sm-4">
						<div class="feature-box center media-box fbox-bg">
							<center><div class="fbox-media">
								<a href="#"><img class="image_fade" src="images/portfolio/3/2.jpg" alt="Featured Box Image"></a>
							</div></center>
							<div class="fbox-desc">
								<h3><font color="#777">Ultra Responsive Design</font></h3>
							</div>
						</div>
					</div>
					<div class="col-sm-4">
						<div class="feature-box center media-box fbox-bg">
						<center>	<div class="fbox-media">
								<a href="#"><img class="image_fade" src="images/portfolio/3/3.jpg" alt="Featured Box Image"></a>
							</div></center>
							<div class="fbox-desc">
								<h3><font color="#777">400+ HTML Pages Included</font></h3>
							</div>
						</div>
					</div>
					</div>
				...
				<section class="page-section topmargin-lg" id="section-numbers">
				<div class="row clearfix bottommargin-lg common-height">
					...
					<div class="col-md-3 col-sm-6 dark center col-padding" style="background-color: rgb(81, 88, 117); height: 326px;">
						<div>
							...
							<div class="counter counter-lined light"><span data-from="100" data-to="846" data-refresh-interval="50" data-speed="2000">846</span>K</div>
							<h5>Lines of Codes</h5>
						</div>
					</div>

					<div class="col-md-3 col-sm-6 dark center col-padding" style="background-color: rgb(87, 111, 158); height: 326px;">
						<div>
							<i class="i-plain i-xlarge divcenter icon-line2-graph"></i>
							<div class="counter counter-lined light"><span data-from="3000" data-to="21500" data-refresh-interval="100" data-speed="2500">21500</span></div>
							<h5>KBs of HTML Files</h5>
						</div>
					</div>

					<div class="col-md-3 col-sm-6 dark center col-padding" style="background-color: rgb(102, 151, 185); height: 326px;">
						<div>
							<i class="i-plain i-xlarge divcenter icon-line2-layers"></i>
							<div class="counter counter-lined light"><span data-from="10" data-to="408" data-refresh-interval="25" data-speed="3500">408</span></div>
					...
					<div class="col-md-3 col-sm-6 dark center col-padding" style="background-color: rgb(136, 195, 216); height: 326px;">
						<div>
							...
							<div class="counter counter-lined light"><span data-from="60" data-to="1400" data-refresh-interval="30" data-speed="2700">1400</span></div>
				...
				<br>
				<section class="page-section topmargin-lg" id="section-principles">
					<div class="heading-block center">
						<h2>Principles</h2>
						
					</div>
				<div class="col-md-12  common-height bottommargin-lg">
			...
			<br>
		<section id="oc-clients-full" class="page-section topmargin-lg">		
<div class="col-md-12  common-height bottommargin-lg">
	<div  class="owl-carousel image-carousel carousel-widget" data-margin="30" data-nav="false" data-loop="true" data-autoplay="5000" data-pagi="false" data-items-xxs="2" data-items-xs="3" data-items-sm="4" data-items-md="5" data-items-lg="6">
						...
						<a href="#"><img src="../images/alliances/amazon-3.png" alt="Clients" class="img-responsive grayscale"></a>
						<a href="#"><img src="../images/alliances/apigee-3.png" alt="Clients" class="img-responsive grayscale"></a>
						<a href="#"><img src="../images/alliances/atlassian-3.png" alt="Clients" class="img-responsive grayscale"></a>
						<a href="#"><img src="../images/alliances/axway-3.png" alt="Clients" class="img-responsive grayscale"></a>
						<a href="#"><img src="../images/alliances/cloudera-3.png" alt="Clients" class="img-responsive grayscale"></a>
						
						<a href="#"><img src="../images/alliances/ibm-3.png" alt="Clients" class="img-responsive grayscale"></a>
						<a href="#"><img src="../images/alliances/microsoft-4.png" alt="Clients" class="img-responsive grayscale"></a>
						<a href="#"><img src="../images/alliances/oracle-4.png" alt="Clients" class="img-responsive grayscale"></a>
						<a href="#"><img src="../images/alliances/pitney-3.png" alt="Clients" class="img-responsive grayscale"></a>
						<a href="#"><img src="../images/alliances/rally-3.png" alt="Clients" class="img-responsive grayscale"></a>
						<a href="#"><img src="../images/alliances/redhat-3.png" alt="Clients"class="img-responsive grayscale"></a>
