...
.middle-block {
  width: 100%;
  height: 100%;
  background: url('images/Webp.net.jpg');
...
<br>
		...
		<section id="section-positions" class="page-section topmargin-lg">
                   ...
                   <br>
                  <p style="max-width:100%;" class="methodText head"><font color="#ffffff" >At Miracle we provide a solid foundation for young learners to build their careers and shape their future. <br>Being a tech savvy company, our encouraging and energetic environment helps young talent to<br> blossom and grow. Join us today to make your mark on the IT field with new disruptive<br> innovations.</font></p>
                  <a href="#" class="button button-border button-light button-rounded uppercase nomargin middle-btn">Read More</a>
                  <br><br><br><br>
                   </div>
