						...
						<div class="swiper-slide dark swiper-slide-active" style="background-image: url(&quot;images/slider/swiper/1.jpg&quot;); height: 494px; width: 1263px;">
							<div class="container clearfix">
								<div class="slider-caption slider-caption-center" style="transform: translateY(0px); opacity: 1; top: 164px;">
									<h2 data-caption-animate="fadeInUp" class="fadeInUp animated">Technical Webinar : Exploring DataPower Operations Dashboard for a Multi-Channel Gateway </h2>
									<p data-caption-animate="fadeInUp" data-caption-delay="200" class="fadeInUp animated">March 08 , 2017</p>
									<center><button type="button" class="btn btn-transparent btn-lg">Register</button></center>
								</div>
							</div>
						</div>
				...
				<div class="row clearfix bottommargin-lg common-height">
					...
					<div class="col-md-3 col-sm-6 dark center col-padding" style="background-color:#00aae7; height: 326px;">
						<div>
							...
							<div class="counter counter-lined light"><span data-from="1" data-to="20" data-refresh-interval="50" data-speed="2000">20</span></div>
							<h5>No of Partners</h5>
						</div>
					</div>
					...
					<div class="col-md-3 col-sm-6 dark center col-padding" style="background-color: #2368a0; height: 326px;">
						<div>
							...
							<i class="i-plain i-xlarge divcenter fa fa-facebook-official"></i>
							<div class="counter counter-lined light"><span data-from="1" data-to="4728" data-refresh-interval="100" data-speed="2500">21500</span></div>
					...
					<div class="col-md-3 col-sm-6 dark center col-padding" style="background-color:#0d416b; height: 326px;">
						<div>
							<i class="i-plain i-xlarge divcenter fa fa-desktop"></i>
							<div class="counter counter-lined light"><span data-from="1" data-to="100" data-refresh-interval="25" data-speed="3500">408</span></div>
							<h5>No. of Webinars we Did</h5>
						</div>
					</div>
