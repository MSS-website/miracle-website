...
<html lang="en">
    ...
    <![endif]-->
        ...
        <style>
         ...
         /* your image */
         url("../images/technologies/application-integration.png");
            ...
            <div class="container ">
               <div class="row">
                  ...
                  <div class="col-sm-6 text-left">
                     <h1 class="heavy micro">SOA, Connectivity and Middleware</h1>
                  </div>
				  <br>
                  <div class="col-sm-6 text-right">
                     <ul class="breadcrumb pull-right">
                        ...
                        <li class="active">SOA, Connectivity and Middleware</li>
                     </ul>
                  </div>
               </div>
            </div>
                        ...
                        <div class="tab-pane active" id="overview">
                            ...
                            <div class="row">
                                <div class="col-sm-3 center">
                                    <center>
                                    <img class="img-responsive" src="../images/services/app-integration.png" alt="App-Integration" title="App Integration"><br>
                                    </center>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <h3 class="heavy">
                                ...
                                <div class="col-sm-3 center">
                                    <center>
                                    <img class="img-responsive" src="../images/services/cloud-integration.png" alt="Cloud-integration" title="Cloud Integration"><br>
                                    </center>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <h3 class="heavy">
                                ...
                                <div class="col-sm-3 center">
                                    <center>
                                    <img class="img-responsive" src="../images/services/process-integration.png" alt="Process-Integration" title="Process Integration"><br>
                                    </center>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <h3 class="heavy">
                                ...
                                <div class="col-sm-3 center">
                                    <center>
                                    <img class="img-responsive" src="../images/services/mobile-integration.png" alt="Mobile-Integration" title="Mobile Integration"><br>
                                    </center>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <h3 class="heavy">
