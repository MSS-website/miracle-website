...
ul li a{
     ...
     <header id="header" class="transparent-header full-header page-section" data-sticky-class="not-dark">
			...
			<div id="header-wrap">
				...
				<div class=" clearfix">
					...
					============================================= -->
					<div id="logo">
						<a href="index.html" class="standard-logo" data-dark-logo="../miracle-logo.svg" width="150px" height="70px"><img src="../miracle-logo.svg" width="150px" height="70px"alt="Miracle Logo" style="margin-left:15px; margin-top: -2px;"></a>
 ...
 <div class="row col-sm-12 col-md-12 col-xs-12 col-lg-12" style="margin:0px !important;">
   <div  class="col-sm-4 col-lg-4 col-md-4 col-xs-12">
    	<div>
			<img style="border:1px solid #232527;width:400px;height:300px;"  class='img-responsive'  src="valentine.png" />
		</div>
		
		<div>
			 <div class="col-sm-10 col-lg-10 col-md-10 col-xs-10" style="pasition:relative;top:-30px;left:80px;border:1px solid #232527;padding:10px;background-color:rgb(255,255,255);">
			    <p><b><span style="font-size:20px;">Valentines Day | 2017</span><br>&nbsp;<span style="color:#ef4048;">-&nbsp;February 14th , 2017</b></span></p>
			    <p>Roses are red! Love is pure! And it's Valentine's...
			    <a href="http://www.miraclesoft.com/events/valentines-day-2017.php"><button type="button" class="btn btn-danger btn-xs">Read More</button></a></p>
		     </div>
		</div>
   ...
   <div  class="col-sm-4 col-lg-4 col-md-4 col-xs-12">
    	<div>
			<img style="border:1px solid #232527;width:400px;height:300px;"  class='img-responsive'  src="events1.png" />
		</div>
		
		<div>
			 <div class="col-sm-10 col-lg-10 col-md-10 col-xs-10" style="pasition:relative;top:-30px;left:80px;border:1px solid #232527;padding:10px;background-color:rgb(255,255,255);">
			    <p><b><span style="font-size:20px;">Quarterly Meet 1 | 2017</span><br>&nbsp;<span style="color:#ef4048;">-&nbsp;May 4th, 2017</b></span></p>
			    			    <p>The beautiful evening on the first quarterly meet of 2017...
			    <a href="http://www.miraclesoft.com/events/valentines-day-2017.php"><button type="button" class="btn btn-danger btn-xs">Read More</button></a></p>
		     </div>
		</div>
     ...
     <div  class="col-sm-4 col-lg-4 col-md-4 col-xs-12">
    	<div>
			<img style="border:1px solid #232527;width:400px;height:300px;"  class='img-responsive'  src="internship-2017.png" />
		</div>
		
		<div>
			 <div class="col-sm-10 col-lg-10 col-md-10 col-xs-10" style="pasition:relative;top:-30px;left:80px;border:1px solid #232527;padding:10px;background-color:rgb(255,255,255);">
			    <p><b><span style="font-size:20px;">Internship | 2017</span><br>&nbsp;<span style="color:#ef4048;">-&nbsp;May 3th, 2017</b></span></p>
			    <p>We along with AP Cloud, have started a summer internship program...
			    <a href="http://www.miraclesoft.com/events/valentines-day-2017.php"><button type="button" class="btn btn-danger btn-xs">Read More</button></a></p>
		     </div>
		</div>
