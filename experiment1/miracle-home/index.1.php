...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-3 col-xs-9">
                        ...
                        <div class="logo_area">
                            <a href="index.html">
                                <img src="../../images/logo-black.png" class="img-responsive" style="height:75%;width:75%;">
                            </a>
                        </div>
                    </div>
        ...
        <div class="slider-area educamp">
            ...
            <div class="edu-c edu-d edu-pre">
                <div id="edu-n-slider" class="slides">
                    <img src="../../images/slider/banner1.png" alt="" title="#slider-direction-1">
                    <img src="../../images/slider/banner2.png" alt="" title="#slider-direction-2">
                </div>
                            ...
                            <div id="slider-direction-1" class="slider-direction">
                                <div class="slider-content text-left lft-pr d-table slider-1">
                                    <div class="title-container d-table-c title-compress">
                                        <h2 class="title1">Education is Power</h2>
                                        <h3 class="title2">Educating the mind without educating the heart is no education at all.</h3>
                                        <a href="#">Find A Coures</a>
                                    </div>
                                </div>
                                <!-- layer 1 -->
                                <div class="layer-1">
                            ...
                            <div id="slider-direction-2" class="slider-direction">
                                <div class="slider-content text-left d-table slider-2 lft-pr">
                                    <div class="title-container d-table-c">
                                        <h2 class="title1">EduCamp is Awesome</h2>
                                        <h3 class="title2">Education is the most powerful weapon which you can use to change the world.</h3>
                                        <a href="#">Enroll Now</a>
                                    </div>
                                </div>
                                <!-- layer 2 -->
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="section_heading wow fadeInUp">
                        ...
                        <h4 class="wow fadeInUp">Best Services</h4>
                    </div>
                    <!-- Section Heading End -->
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="section_heading wow fadeInUp">
                        <img src="img/coures-icon.png" alt="">
                        <h4 class="wow fadeInUp">Upcoming Events</h4>
                    </div>
                    ...
                    <div class="single_courses">
                        <div class="single_courses_thumb">
                            ...
                            <div class="hover_overlay">
                                <div class="links">
                                    <a class="magnific-popup" href="img/event-1.jpg"><i class="fa fa-search" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="single_courses_desc">
                            ...
                            <div class="price_rating_area">
                                <ul data-countdown="2019/01/01 14:21:37" class="timer">
                ...
                <div class="col-md-4 col-xs-12">
                    <div class="single_courses">
                        <div class="single_courses_thumb">
                            ...
                            <div class="hover_overlay">
                                <div class="links">
                                    <a class="magnific-popup" href="img/event-2.jpg"><i class="fa fa-search" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        </div>
                        <!-- Single Courses Image Area End -->
                ...
                <div class="col-md-4 col-xs-12">
                    <div class="single_courses">
                        <div class="single_courses_thumb">
                            ...
                            <div class="hover_overlay">
                                <div class="links">
                                    <a class="magnific-popup" href="img/event-3.jpg"><i class="fa fa-search" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        </div>
                        <!-- Single Courses Image Area End -->
    ...
    <section class="why_choose_us_area home2 section_padding_100">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <div class="section_heading wow fadeInUp">
                        <img src="img/why-choose-icon.png" alt="">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="section_heading wow fadeInUp">
                        ...
                        <h4 class="wow fadeInUp">Blog &amp; News</h4>
                    </div>
                </div>
            </div>
            <div class="row">
    ...
    <div class="video_area section_padding_60">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <div class="video_play_area wow fadeInUp">
    ...
    <footer class="footer_area">
        <div class="container">
            <div class="row">
                ...
                <!-- Upcoming Area Start -->
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="footer_upcoming_event">
                        <div class="title">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    &copy; 2016 <a target="_blank" href="http://www.miraclesoft.com" title="Copyright" itemprop="url">Miracle Software Systems, Inc.</a>
                </div>
                <div class="col-sm-6">
