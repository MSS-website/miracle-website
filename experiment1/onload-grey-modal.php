...
<script type="text/javascript">
    ...
    <body>
        <div row="row">
            <div class="modal fade hide" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
              <div class="modal-dialog" >
                <div class="modal-content" style="background :#383838 " >
                   ...
                   <div class="modal-header">
                    ...
                    <h3 style="color:#fff!important; font-size: 34px !important;"><strong>On-Demand Webinar</strong></h3>
      ...
      <hr>
        ...
        <p class="methodText" style="color:#fff!important;">Access and hear what our experts said about <strong>"Accelerate the value of your Salesforce investments with IBM Cloud Integration"</strong> </p>
        <div class="row">
         
         
          <div class="col-sm-4">
           <a href="http://www.miraclesoft.com/resource/get-resource.php?refId=53&objectId=4&eventId=44"><button type="button" class="btn btn-primary btn-lg" >Watch Replay </button></a>   
           </div></div>
